    ...
    <div className="min-h-screen bg-cyber-dark text-cyber-text p-8">
      ...
      <div className="max-w-3xl mx-auto bg-cyber-dark/80 rounded-lg shadow-lg p-8 mt-8">
        ...
        <div className="bg-cyber-dark/70 rounded-md p-6 border border-cyber-blue/20">
          ...
          <p className="mb-4">The core command in Polybiuos is `polybiuos open [path]`, which launches the Polybiuos interface in your working directory. It reads the necessary context and prepares to take your requests.</p>
          ...
          <pre className="bg-cyber-terminal border border-cyber-green/30 rounded p-4 overflow-x-auto mb-4"><code className="text-cyber-green">polybiuos open [path]</code></pre>
          ...
          <p className="mb-2">The AI will dynamically analyze the context of your project, ensuring that the information is relevant and up-to-date. Here are more example requests you could ask polybiuos:</p>
          <pre className="bg-cyber-terminal border border-cyber-green/30 rounded p-4 overflow-x-auto mb-4">
          <code className="text-cyber-green">> Generate CLI app boilerplate in main.rs</code><br></br>
          <code className="text-cyber-green"># Polybious doesn't need explicit file paths, it can figure them out on its own</code><br></br>
          ...
          <p className="mb-4">You can create `.eigenignore` file in your project directory with `.gitignore` syntax to exclude files and folders from the Polybiuos context.</p>
          <pre className="mb-4 text-cyber-text"><strong>Context Management</strong></pre>
          <p className="mb-4">Polybiuos intelligently manages context dynamically to avoid overload. The system’s memory ensures that it only retains the necessary context, so you won’t encounter information overload. This efficient memory system helps improve the accuracy and relevance of AI responses.</p>
        </div>
      </div>
    </div>
  );
