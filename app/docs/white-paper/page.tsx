  ...
  return (
    <div className="min-h-screen bg-cyber-dark text-cyber-text p-8">
      ...
      <div className="max-w-3xl mx-auto bg-cyber-dark/80 rounded-lg shadow-lg p-8 mt-8">
        ...
        <h1 className="text-3xl font-bold text-cyber-blue mb-6">Eigencode: Intelligent Programming</h1>
        <section className="mb-8">
          ...
          <div className="bg-cyber-blue/10 rounded-lg p-4 mb-2">
            <p className="text-sm">
              Eigencode is a framework for intelligent programming, designed to enhance human-computer interaction in software development. By leveraging the computational capabilities of functional models within domain-specific boundaries, Eigencode creates a new paradigm that combines the intent of human creativity with machine intelligence.
            </p>
          </div>
        </section>
        <section className="mb-8">
          ...
          <p>
            Eigencode represents a new approach to this relationship—a framework that allows us not to replace human programmers, but to amplify, coordinate, and further enhance human capabilities through a carefully designed interplay of programmatic control, context, and machine intelligence.
          </p>
        </section>
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-cyber-blue mb-2">Core Model: AI-Oriented Software Architecture</h2>
          <p className="mb-2">
            At the heart of Eigencode is a common software architecture that provides structure and predictability in all AI solutions. Rather than creating one-off systems for specific requirements, an intent-driven command meta-system abstracts pattern-specific features within a domain-oriented framework.
          </p>
          <p>
...
{`// Example: command definition
{
  ...
  "scope": "modeling"
        ...
        <section className="mb-8">
          ...
          <p className="mb-2">
            Eigencode models the entire human-in-the-loop context as part of the software development process. This includes:
          </p>
          ...
          <p>
            By continually mapping each of these layers, Eigencode’s integrated response mechanisms lead to more meaningful output and help the individual maintain their creative vision without losing efficiency.
          </p>
        </section>
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-cyber-blue mb-2">2. Expressive Model System</h2>
          <p className="mb-2">
            Eigencode models are generalizable and can engage with the constructs of software engineering: requirements, functional modules, and operational models are recursively woven as generative models operate within explicit constraints.
          </p>
          <ul className="list-disc list-inside mb-2">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside mb-2">
            <li>Eigencode provides deep analytic capabilities that go beyond syntax highlighting</li>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-cyber-blue mb-2">Eigencode Command Registry</h2>
          <p className="mb-2">
            The Eigencode framework incorporates an intent-driven command meta-paradigm of human-AI collaboration in software development. Future management directions include:
          </p>
          <ul className="list-disc list-inside mb-2">
        ...
        <section className="mb-8">
          ...
          <p className="mb-2">
            Eigencode provides a framework that bridges the gap between traditional model cognition and the software engineering process. Through continual context awareness, it builds a solution that is both robust and responsive to human creativity.
          </p>
          <p className="mb-2">
            This approach enables a new software architecture that maximizes developer productivity, code quality, and overall software system expressiveness. A structured foundation and an active command registry give the Eigencode framework provides an active interface that channels these advancements into practical developer benefits.
          </p>
        </section>
        <footer className="mt-12 text-center text-xs text-cyber-text/60">
          Eigencode Docs are © 2025 Eigencode. All rights reserved.
        </footer>
        </div>
      </div>
    </div>
