  ...
  return (
    <div className="min-h-screen bg-cyber-dark text-cyber-text p-8">
      ...
      <div className="max-w-3xl mx-auto bg-cyber-dark/80 rounded-lg shadow-lg p-8 mt-8">
        ...
        <h1 className="text-3xl font-bold text-cyber-blue mb-6 mt-4">{'>'} Getting Started with Polybiuos</h1>
        <p className="mb-2">
          Welcome to Polybiuos! This guide will help you get up and running with the Polybiuos platform, allowing you to leverage AI-powered commands in your development workflow.
        </p>
        <div className="flex flex-wrap gap-6 mb-8">
          <div className="bg-cyber-dark/80 border border-cyber-blue/20 rounded-lg p-6 flex-1 min-w-[260px] max-w-[320px] ">
            ...
            <p className="mb-2 text-sm">Set up Polybiuos in your development environment with ease.</p>
          ...
          <div className="bg-cyber-dark/80 border border-cyber-blue/20 rounded-lg p-6 flex-1 min-w-[260px] max-w-[320px]">
            ...
            <p className="mb-2 text-sm">Learn the basics and run your first Polybiuos commands.</p>
          ...
          <div className="bg-cyber-dark/80 border border-cyber-blue/20 rounded-lg p-6 flex-1 min-w-[260px] max-w-[320px]">
            ...
            <p className="mb-2 text-sm">Initialize Polybiuos in your development environment.</p>
        ...
        <div className="mt-8">
          ...
          <p className="mb-2">Once you're comfortable with the basics, explore these resources to get the most out of Polybiuos:</p>
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>
              <Link href="/docs/white-paper" className="text-cyber-blue hover:underline">White Paper</Link> - Understand the principles behind Polybiuos
            </li>
          </ul>
        </div>
      </div>
